...
By default, links to all pages appear in the main navigation at the top level, ordered alphabetically by their titles. By adding further fields to the front matter of individual pages, you can [change their order]({% link docs/ztd/navigation/main/order.md %}), [exclude pages]({% link docs/ztd/navigation/main/exclude.md %}), and change their [parent pages]({% link docs/ztd/navigation/main/levels.md %}).
